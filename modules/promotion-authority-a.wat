(component
  ...
  (core module $module
    ...
    (global $maximum-operation (mut i64) (i64.const 0))
    (func (export "start") (param $config i64) (result i64)
      local.get $config
      global.set $maximum-operation
      i64.const 1)
    ...
    (func (export "invoke") (param i64) (param $operation i64)
      (param $requested-operation i64) (param $workspace-index i64) (result i64)
      local.get $operation
      i64.const 1
      i64.ne
      if
      ...
      local.get $workspace-index
      i64.eqz
      local.get $requested-operation
      i64.const 0
      i64.gt_u
      i32.and
      local.get $requested-operation
      global.get $maximum-operation
      i64.le_u
      i32.and
      if (result i64)
        i64.const 1
